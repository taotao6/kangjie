<template>
	<view class="uni-swiper__warp">
		...
		<view v-if="mode === 'nav'" key='nav' :style="{'background-color':dotsStyles.backgroundColor,'bottom':'0','right':'0','display':'flex','justify-content':'flex-end'}" class="uni-swiper__dots-box uni-swiper__dots-nav">
