			...
			<view class="mySwiper-in">
				<uni-swiper-dot :info="info" :current="current" field="content" :mode="mode">
					...
					<view class="back" @click="back">
						<image src="http://taotao111.test.upcdn.net/shangp_nav.png" mode="widthFix" style="height: auto;"></image>
					</view>
				</uni-swiper-dot>
				<view class="desc">
					<view class="desc-in">
				...
				<!-- 商品规格 -->
				<s-popup custom-class="demo-popup" position="bottom" v-model="visible" class="mypopup" :preventTouchmove="prevent">
				...
				<view class="bottom-nav">
					...
					<view class="nav-buy" @click="toBuy"><text>立即租贷</text></view>
				</view>
			</view>
		</view>
	</view>
