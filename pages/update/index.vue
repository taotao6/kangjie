<template>
  <view class="flex-column">
    <view class="content">
      <image class="logo" src="http://taotao111.test.upcdn.net/up-circle.png"/>
      <view class="mainInfo">
    ...
    <view>
      <view class="infoContentTitle">
        <image class="infoPic" src="http://taotao111.test.upcdn.net/info-circle.png"/>
    ...
    <view v-if="!currentIsLatest">
      <view class="infoContentTitle">
        <image class="infoPic" src="http://taotao111.test.upcdn.net/sync.png"/>
